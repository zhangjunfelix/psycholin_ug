...
1. **No Clear Phoneme Boundaries**: Speech has no “spaces” between phonemes—acoustic info overlaps.  
2. **Variable Acoustic Signals**: Same phoneme (e.g., /d/) sounds different with adjacent vowels.  
...
1. Listeners use acoustic signals to infer the *articulatory gestures* that made them (e.g., “tongue tip tapped alveolar ridge”).  
2. Link gestures to the speaker’s phonological plan (words/syllables).  
...
1. **Bottom-Up**: Analyze acoustic properties to activate matching phonemes (e.g., rising transition → /d/).  
2. **Top-Down**: Use memory (words, syntax) to pick the best candidate.  
...
1. What are formants and formant transitions?  
2. How does coarticulation challenge speech perception?  
3. What is the core claim of motor theory?  
4. What is the McGurk effect, and how does it support motor theory?  
5. How does the GA approach explain categorical perception?
